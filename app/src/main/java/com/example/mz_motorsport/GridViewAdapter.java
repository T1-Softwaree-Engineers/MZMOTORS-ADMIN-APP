...
public class GridViewAdapter extends BaseAdapter {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        if (view == null) {
            ...
            view = layoutInflater.inflate(R.layout.item_gv_imagen, null);
        }

        ImageView ivImagen = view.findViewById(R.id.ivImagen);
        ImageView ivBtnEliminar = view.findViewById(R.id.ivBtnEliminar);

        ivImagen.setImageURI(listaImagenes.get(i));

        ivBtnEliminar.setOnClickListener(new View.OnClickListener() {
            @Override
